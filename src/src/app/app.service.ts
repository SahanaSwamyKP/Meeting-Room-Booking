...
export class AppService {
 ...
 ////////SlotServices
  ...
  async GetAllSlots(): Promise<Observable<any>>{
    return this.httpClient.get(this.baseAddress+"/Slots",this.httpOptions)
  }
  ...
  ///////////////
  /////RoomServices
  async GetAllRoom(): Promise<Observable<any>>{
    return this.httpClient.get(this.baseAddress+"/Rooms",this.httpOptions);
  }

  DeleteRoom(roomId:number): Observable<any>{
    return this.httpClient.delete(this.baseAddress+`/Rooms?roomId=${roomId}`,this.httpOptions);
  }

  async GetRoomById(roomId:number): Promise<Observable<any>>{
    return this.httpClient.get(this.baseAddress+`/Rooms/${roomId}`,this.httpOptions);
  }

  EditRoom(room: RoomTab): Observable<any>{
